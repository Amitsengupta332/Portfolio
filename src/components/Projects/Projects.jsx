...
const Projects = () => {
    const projectDetails = [

        {
            ...
            description: "A website where users can explore master chefs and their recipes, add them to favorites, and access special features like blog downloads and food artisan highlights. Built with React and Node.js, incorporating CRUD operations, Context API for state management, and Firebase Authentication for secure access.",
        ...
        },
        {
            ...
            tools: 'Tailwind CSS, Firebase, Express',
            description: " A website for exploring and adding children's toys to the cart. Built with React, Node.js, and MongoDB, featuring Firebase Authentication, seamless product loading from MongoDB, and search and sorting functionality for an improved user experience.",
        ...
        },
        {
            ...
            liveSiteLink: 'https://summer-camp-school-7bd49.web.app/?fbclid=IwAR3BZdVhwbz_sQutaPH6LcYGeOVhn7c8LJD0URfP1VouaicHYR2Uiuv8aMs',
        },
    ];
    return (
        <div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-5 mt-10'>
                {
                    projectDetails.map((project, index) => (
                        <div key={index} className="border border-gray-100 overflow-hidden shadow-md hover:shadow-lg transition duration-300 shadow-pink-100 rounded-lg" data-aos="flip-up"
                        ...
                        data-aos-duration="1000">
                            ...
                            <div className="p-4">
                                <p className="  text-justify text-md mb-4">{project.description}</p>
                                <p className=" font-semibold mb-2">Tools: {project.tools}</p>
                                <div className="flex justify-between align-middle">
                                    <div className="space-x-2 pt-2">
                                        <a target='_blank' className='btn btn-outline btn-info' href={project.clientLink}>Client</a>
                                        <a target='_blank' className='btn btn-outline btn-info' href={project.serverLink}>Server</a>
                                        <a target='_blank' className='btn btn-outline btn-info' href={project.liveSiteLink}>Live</a>
                                    </div>
                                </div>
                            </div>
                        </div>
